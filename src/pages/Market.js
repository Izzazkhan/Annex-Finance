        ...
        return [{
            ...
            columns: [
                        ...
                        return (
                            <div className="flex justify-end">
                                <div className="flex flex-col justify-center items-end space-x-2">
                                    ...
                                    <div className="text-sm">
                                        {new BigNumber(row?.original?.supplyAnnexApy)
                                            .dp(2, 1)
                                            .toString(10)}
                                        %
                                    </div>
                        ...
                        return (
                            <div className="flex justify-end">
                                <div className="flex flex-col justify-center items-end space-x-2">
                                    ...
                                    <div className="text-sm">
                                        {new BigNumber(row?.original?.borrowAnnexApy)
                                            .dp(2, 1)
                                            .toString(10)}
                                        %
                                    </div>
                ...
                },
                {
                    ...
                    Cell: ({value}) => {
                        return (
                            <div className="font-bold ml-6 text-right">
                                {currencyFormatter(value)}
                            </div>
                        )
                    }
        ...
        <Layout mainClassName="py-8" title={"Market"}>
            <div>
                <div className="grid grid-cols-1 gap-y-4 md:gap-y-0 md:grid-cols-4 md:gap-x-4 px-10 md:px-0">
                    <MarketSummaryCard title={'Total Supply'}>
                        ${format(totalSupply)}
                    </MarketSummaryCard>

                    <MarketSummaryCard title={'Total Borrow'}>
                        ${format(totalBorrow)}
                    </MarketSummaryCard>
