...
function Auction(props) {
  ...
  console.log('paaaaaaaaaaaaaa', path)
  // let pathname;
  ...
  // }
  return (
    <Layout mainClassName="pt-10 min-h-screen" title={'AuctionList'}>
      <Styles>
        <Switch>
          ...
          <Route exact strict path={`${path}`} component={AuctionList} />
          <Route exact strict path={`${path}/detail/:address`} component={AuctionDetail} />
          <Route exact strict path={`${path}/create`} component={NewAuction} />

          <Redirect to={`${path}`} component={AuctionList} />
          {/* <Route exact strict path={`${path}`} component={NewAuction} />
          <Redirect to={`${path}`} component={NewAuction} /> */}
        </Switch>
      </Styles>
    </Layout>
  );
