...
const Footer = props => {
	...
	return (
		<div className="flex justify-end items-center space-x-5 mt-12 mb-6">
			...
			<a href="https://t.me/Annex_finance_group" className="text-white no-underline focus:outline-none">Support</a>
			<a href="https://annex.finance/Whitepaper.pdf" className="text-white no-underline focus:outline-none">Whitepaper</a>
		</div>
	)
}
